...
namespace Projeto.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        {
            var veiculoTemp = (from veiculo in this.Veiculos where veiculo.Placa == veiculoAlterado.Placa select veiculo).SingleOrDefault();
