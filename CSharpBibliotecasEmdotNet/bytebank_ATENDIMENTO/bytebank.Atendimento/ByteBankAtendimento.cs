    ...
    internal  class ByteBankAtendimento
    {
        ...
        private void ExportarContas()
        {
            ...
            else
            {
                ...
                try
                {
                    FileStream fs = new FileStream(@"C:\Aprendendo CSharp\CSharpBibliotecasEmdotNet\contas.json", 
                        FileMode.Create);
                    using (StreamWriter streamwriter = new StreamWriter(fs))
                    {
                        streamwriter.WriteLine(json);
                    }
                    Console.WriteLine(@"Arquivo salvo em C:\Aprendendo CSharp\CSharpBibliotecasEmdotNet\");
                    Console.ReadKey();
                }
                catch (Exception excecao)
                {
